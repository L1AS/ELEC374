...
add wave -noupdate -radix binary /load_imm_tb/opcode
add wave -noupdate -radix binary /load_imm_tb/CPU/IRout
...
add wave -noupdate -radix hexadecimal /load_imm_tb/CPU/DUT/R0/BusMuxIn
add wave -noupdate -radix hexadecimal /load_imm_tb/CPU/DUT/busMux/busMuxInR0
add wave -noupdate -radix hexadecimal /load_imm_tb/CPU/DUT/busMux/busMuxOut
...
WaveRestoreCursors {{Cursor 1} {717188 ps} 0}
...
update
WaveRestoreZoom {0 ps} {916350 ps}
